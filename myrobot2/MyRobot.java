...
public class MyRobot extends AdvancedRobot {
    ...
    static String dataDir = System.getProperty("user.dir")
            + "\\robots\\myrobot2\\MyRobot.data\\";
    static String winFile = dataDir + "winratio.txt";
    static String lutFile = dataDir + "LookUpTable.csv";
    static NeuralNet nn=new NeuralNet(5,
            20,
            9,
            0.01,
            0.0,
